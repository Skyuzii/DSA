...
public class ArrayQueueTests
{
    ...
    public void EnqueuingItemsOneByOne()
    {
        ...
        Assert.True(queue.Count == itemsCount && queue.Count == trueCount);
    }

    [Fact]
    public void DequeuingAllItemsExceptOne()
    {
        var queue = new ArrayQueue<int>();
        ...
        var trueCount = queue.Count();

        Assert.True(queue.Count == 1 && trueCount == 1);
    }
    ...
    public void EnqueuingAfterClearingCollection()
    {
        ...
        Assert.True(queue.Count == itemCount && queue.Count == trueCount);
    }
    ...
    public void DequeuingHalfTheItemsAndEnquingTwiceAsMuch()
    {
        ...
        Assert.True(queue.Count == trueCount && itemCount == trueCount);
    }
}